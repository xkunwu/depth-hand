...
class super_udir2(base_regre):
    @staticmethod
    def get_trainer(args, new_log):
        from train.train_super_udir2 import train_super_udir2
        return train_super_udir2(args, new_log)

    def __init__(self, args):
        super(super_udir2, self).__init__(args)
    ...
    def receive_data(self, thedata, args):
        ...
        super(super_udir2, self).receive_data(thedata, args)
