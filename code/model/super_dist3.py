...
class super_dist3(base_conv3):
    """ 3d offset detection based method
    """
    @staticmethod
    def get_trainer(args, new_log):
        from train.train_super_dist3 import train_super_dist3
        return train_super_dist3(args, new_log)

    def __init__(self, args):
        super(super_dist3, self).__init__(args)
    ...
    def receive_data(self, thedata, args):
        ...
        super(super_dist3, self).receive_data(thedata, args)
